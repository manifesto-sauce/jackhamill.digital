    ...
    <>
      ...
      {projects
        ...
        className='w-1/2 md:w-1/4 lg:w-1/6 aspect-3/2 p-4'
            innerClassName='border border-accent w-full aspect-3/2 p-4 rounded hover:bg-accent/30 transition-colors duration-300 relative bg-black/50 backdrop-blur-lg'
          />
        ))}
    </>
  )
