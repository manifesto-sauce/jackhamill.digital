  ...
  return (
    <>
      {filteredProjects.length > 0 ? (
        ...
        <div className="flex items-center justify-center min-h-[50vh] [mt-50vh]">
          <p className="text-lg text-center text-gray-400">Sort by category on the left. "Compositions" refers to pieces where I was not the sole performer. "Performances" includes all projects where I was the solo performer. "Fixed media" refers to work without performers. </p>
        </div>
      )}
    </>
  )
